...
## [0.38.0](https://github.com/marklove5102/rtk/compare/v0.37.2...v0.38.0) (2026-04-25)


### Features

* 9-tool AI agent support + emoji removal ([#704](https://github.com/marklove5102/rtk/issues/704)) ([737dada](https://github.com/marklove5102/rtk/commit/737dada4a56c0d7a482cc438e7280340d634f75d))
* add 11 new TOML built-in filters (xcodebuild, jq, basedpyright, ty, skopeo, stat, biome, oxlint, jj, ssh, gcc) ([#490](https://github.com/marklove5102/rtk/issues/490)) ([e5e2f87](https://github.com/marklove5102/rtk/commit/e5e2f8760679a01388235efd3f43a0a0ae82f1f6))
* add 32 TOML-filtered commands to hook rewrite rules ([#475](https://github.com/marklove5102/rtk/issues/475)) ([91289d7](https://github.com/marklove5102/rtk/commit/91289d761b289c4f85556db4c667bf1d8ebe6ce5))
* add Claude Code skills for PR and issue triage ([#343](https://github.com/marklove5102/rtk/issues/343)) ([6ad6ffe](https://github.com/marklove5102/rtk/commit/6ad6ffeccee9b622013f8e1357b6ca4c94aacb59))
* add Cline/Roo Code support via rtk init --agent cline ([#701](https://github.com/marklove5102/rtk/issues/701)) ([#702](https://github.com/marklove5102/rtk/issues/702)) ([d921cc4](https://github.com/marklove5102/rtk/commit/d921cc4fa0324843c82523085cca2014b075a12e))
* add Cursor Agent support via --agent flag ([#595](https://github.com/marklove5102/rtk/issues/595)) ([c3917e4](https://github.com/marklove5102/rtk/commit/c3917e4de2a21f9507abf73b09921a6be36a9aed))
* add Gemini CLI support via rtk init --gemini ([#573](https://github.com/marklove5102/rtk/issues/573)) ([f16853a](https://github.com/marklove5102/rtk/commit/f16853ae8a539d6095b8e3693d64a82708d427ae))
* add OpenCode plugin support ([#300](https://github.com/marklove5102/rtk/issues/300)) ([064cb3e](https://github.com/marklove5102/rtk/commit/064cb3ea65fd499ac0d58c2e76004f06ca1a6e1e))
* add rtk session command for adoption overview ([be67d66](https://github.com/marklove5102/rtk/commit/be67d660100c06a0751c08d943dc884ad5bff6a3))
* add rtk session command for adoption overview ([12d44c4](https://github.com/marklove5102/rtk/commit/12d44c4068d7d4f65d5bd7551af29ab5a2352ed1)), closes [#487](https://github.com/marklove5102/rtk/issues/487)
* add structured dotnet support (build/test/restore/format) ([a8dbe33](https://github.com/marklove5102/rtk/commit/a8dbe33b84320207323c738d76d6ef3dbb470298))
* add Windsurf support via rtk init --agent windsurf ([#695](https://github.com/marklove5102/rtk/issues/695)) ([#697](https://github.com/marklove5102/rtk/issues/697)) ([86d5069](https://github.com/marklove5102/rtk/commit/86d50698c18279c0c5e448ebeaaa5d6f62836cba))
* add worktree slash commands for isolated development ([#364](https://github.com/marklove5102/rtk/issues/364)) ([ab83e79](https://github.com/marklove5102/rtk/commit/ab83e7933ebc26ca76f843d33285729875efb913))
* anonymous telemetry ping (1/day, opt-out) ([#334](https://github.com/marklove5102/rtk/issues/334)) ([baff6a2](https://github.com/marklove5102/rtk/commit/baff6a2334b155c0d68f38dba85bd8d6fe9e20af))
* **aws:** expand CLI filters from 8 to 25 subcommands ([402c48e](https://github.com/marklove5102/rtk/commit/402c48e66988e638a5b4f4dd193238fc1d0fe18f))
* **aws:** expand CLI filters from 8 to 25 subcommands ([d1b37ce](https://github.com/marklove5102/rtk/commit/d1b37ced0154ad2d78409191bf5be3215a93a18a))
* **benchmark:** add multipass VM integration test suite ([6e7863b](https://github.com/marklove5102/rtk/commit/6e7863bf313b0d18a47cf0ca2cdaea03cc2ed900))
* **benchmark:** add multipass VM integration test suite ([d22759b](https://github.com/marklove5102/rtk/commit/d22759b8c5254ad9c4a455f10cb7de75e92df581))
* **benchmark:** add Swift ecosystem tests (6 commands + savings) ([1fbb6d9](https://github.com/marklove5102/rtk/commit/1fbb6d935b4a0d031a7862cba312eebe1303ba9b))
* Claude Code tooling — 2 agents, 7 commands, 2 rules, 4 skills ([#491](https://github.com/marklove5102/rtk/issues/491)) ([7b7a5ae](https://github.com/marklove5102/rtk/commit/7b7a5ae4b6d23fbb882ed7d5e815e2ed0672c46c))
* **copilot:** add Copilot hook support (VS Code + CLI) ([#605](https://github.com/marklove5102/rtk/issues/605)) ([0800bbe](https://github.com/marklove5102/rtk/commit/0800bbecef3c1744336aaab36f6888066a258c2e))
* **core:** binary hook w/ native cmd exec + streaming ([7b0f5e1](https://github.com/marklove5102/rtk/commit/7b0f5e1ba9b83ff6ce214cd481f7c9eac1d5f87b))
* **discover:** handle more npm/npx/pnpm/pnpx patterns ([9e96caa](https://github.com/marklove5102/rtk/commit/9e96caa0a18a95c84da82ba57716a9d3ef86d0c8))
* **discover:** handle more npm/npx/pnpm/pnpx patterns ([bab3a53](https://github.com/marklove5102/rtk/commit/bab3a53f24f95a4a5821b23712f0b7f2ce3e0445))
* **discover:** treat yadm commands like git ([ffec420](https://github.com/marklove5102/rtk/commit/ffec42078994d668995a2ccca7ae905528b9e189)), closes [#567](https://github.com/marklove5102/rtk/issues/567)
* **go:** Support golangci-lint via go tool ([8ab0f3d](https://github.com/marklove5102/rtk/commit/8ab0f3da47578e80086aaa29f072aa703fec79a0))
* **go:** Support golangci-lint via go tool ([8f985a2](https://github.com/marklove5102/rtk/commit/8f985a22d19a335ffb173f206ea69d4cf2d896ae))
* **gt:** add Graphite CLI support ([#290](https://github.com/marklove5102/rtk/issues/290)) ([7fbc4ef](https://github.com/marklove5102/rtk/commit/7fbc4ef4b553d5e61feeb6e73d8f6a96b6df3dd9))
* **hooks:** native hook handlers, remove bash scripts ([22892f0](https://github.com/marklove5102/rtk/commit/22892f02439fbd85593b0925e558852dafcb5da0))
* **init:** add --copilot flag for GitHub Copilot integration ([9e19aac](https://github.com/marklove5102/rtk/commit/9e19aac75e790ecbfd1dc5b2d01786f6b9edf506)), closes [#823](https://github.com/marklove5102/rtk/issues/823)
* **init:** add Codex CLI support via AGENTS.md + RTK.md workflow ([#377](https://github.com/marklove5102/rtk/issues/377)) ([7d04b48](https://github.com/marklove5102/rtk/commit/7d04b485a7a9e6ef77ff447ccf34340c359524e6))
* **init:** add native support for Kilo Code and Google Antigravity ([d0a3797](https://github.com/marklove5102/rtk/commit/d0a3797ec580f96948489d1e7c3329ac22a6c4eb))
* **init:** add support for kilocode and antigravity agents ([66b90f1](https://github.com/marklove5102/rtk/commit/66b90f1ed3de81acdce61164c068c24ed7ef29db))
* **js:** distinguish between `jest` and `vitest` and don't rewrite `npm test` commands as we don't know which test framework is used under the hood ([45938b2](https://github.com/marklove5102/rtk/commit/45938b2a4d3fe76685a6e008f210bb276df50319))
* OpenClaw plugin for transparent exec rewriting ([#358](https://github.com/marklove5102/rtk/issues/358)) ([56160d8](https://github.com/marklove5102/rtk/commit/56160d839998941dfc608b48652792f68d4fec11))
* **pnpm:** Add filter argument support ([2ba8d37](https://github.com/marklove5102/rtk/commit/2ba8d372df186b4056a3b8906fc25cde8586dd42))
* **pnpm:** Add filter argument support ([a39ac43](https://github.com/marklove5102/rtk/commit/a39ac4382a3d118b281ffd5e532cf93aeae2e3f0)), closes [#259](https://github.com/marklove5102/rtk/issues/259)
* **pnpm:** handle pnpm build rewrite ([f936138](https://github.com/marklove5102/rtk/commit/f93613881939bc278261e9143bd328c82c696a33))
* **refacto-codebase-onboarding:** partie 1 - folders and technical docs ([2efe860](https://github.com/marklove5102/rtk/commit/2efe860f45efa1be319949f0385655e21d9f4cbb))
* **refacto-core:** binary hook w/ native cmd exec + streaming ([e7b7f9a](https://github.com/marklove5102/rtk/commit/e7b7f9ab665a0f7303d41d23ad156d24e5e8964e))
* rewrite engine, OpenCode support, hook system improvements ([#539](https://github.com/marklove5102/rtk/issues/539)) ([c1de10d](https://github.com/marklove5102/rtk/commit/c1de10d94c0a35f825b71713e2db4624310c03d1))
* **ruby:** add Ruby on Rails support (rspec, rubocop, rake, bundle) ([#724](https://github.com/marklove5102/rtk/issues/724)) ([15bc0f8](https://github.com/marklove5102/rtk/commit/15bc0f8d6e135371688d5fd42decc6d8a99454f0))
* **skills:** add /pr-review skill for batch PR review ([21e67a1](https://github.com/marklove5102/rtk/commit/21e67a1113041b74542d0285e5f74587dfb30b65))
* **skills:** add /pr-review skill for systematic batch PR review ([fb33202](https://github.com/marklove5102/rtk/commit/fb332022925bbb69b4a40f0276589e0a9cdfef23))
* **stream:** P1 fixes from PR [#956](https://github.com/marklove5102/rtk/issues/956) review ([71eeeda](https://github.com/marklove5102/rtk/commit/71eeedab4d771986b3d3dc5c439f5646135ff96c))
* **stream:** standardize command execution with exec_capture() ([a2312df](https://github.com/marklove5102/rtk/commit/a2312df5f2533639afd937686d94e12eab7760bd))
* take review into account ([bad5fe9](https://github.com/marklove5102/rtk/commit/bad5fe90f42b939ccf832fbb94bbe068bbc3e89d))
* **telemetry:** add retention, ecosystem, economics, and config metrics ([450ed10](https://github.com/marklove5102/rtk/commit/450ed107abb1f27270f3c968f7cde0fe8d817c0d))
* **telemetry:** enrich daily ping with gap detection and quality metrics ([644c50f](https://github.com/marklove5102/rtk/commit/644c50f786e5c567617e7ea907c5f312797b1265))
* **telemetry:** enrich daily ping with gap detection and quality metrics ([d57de86](https://github.com/marklove5102/rtk/commit/d57de86d88533413fe2b8a560713fe981de481c6))
* TOML Part 1 — filter DSL engine + 14 built-in filters ([#349](https://github.com/marklove5102/rtk/issues/349)) ([adda253](https://github.com/marklove5102/rtk/commit/adda2537be1fe69625ac280f15e8c8067d08c711))
* TOML Part 2 — user-global config, shadow warning, rtk init templates, 4 new built-in filters ([#351](https://github.com/marklove5102/rtk/issues/351)) ([926e6a0](https://github.com/marklove5102/rtk/commit/926e6a0dd4512c4cbb0f5ac133e60cb6134a3174))
* TOML Part 3 — 15 additional built-in filters (ping, rsync, dotnet, swift, shellcheck, hadolint, poetry, composer, brew, df, ps, systemctl, yamllint, markdownlint, uv) ([#386](https://github.com/marklove5102/rtk/issues/386)) ([b71a8d2](https://github.com/marklove5102/rtk/commit/b71a8d24e2dbd3ff9bb423c849638bfa23830c0b))
* warn when installed hook is outdated ([#344](https://github.com/marklove5102/rtk/issues/344)) ([#350](https://github.com/marklove5102/rtk/issues/350)) ([3141fec](https://github.com/marklove5102/rtk/commit/3141fecf958af5ae98c232543b913f3ca388254f))


### Bug Fixes

* 4 critical bugs + telemetry enrichment ([#462](https://github.com/marklove5102/rtk/issues/462)) ([7d76af8](https://github.com/marklove5102/rtk/commit/7d76af84b95e0f040e8b91a154edb89f80e5c380))
* 6 critical bugs — exit codes, unwrap, lazy regex ([#626](https://github.com/marklove5102/rtk/issues/626)) ([3005ebd](https://github.com/marklove5102/rtk/commit/3005ebd0ad07912ae919687f6d3d49482aabaeac))
* add telemetry documentation and init notice ([#640](https://github.com/marklove5102/rtk/issues/640)) ([#788](https://github.com/marklove5102/rtk/issues/788)) ([0eecee5](https://github.com/marklove5102/rtk/commit/0eecee5bf35ffd8b13f36a59ec39bd52626948d3))
* add tokens_saved to telemetry payload ([#471](https://github.com/marklove5102/rtk/issues/471)) ([#472](https://github.com/marklove5102/rtk/issues/472)) ([f8b7d52](https://github.com/marklove5102/rtk/commit/f8b7d52d2d25d09a44f391576bad6a7b271f1f8c))
* address code review — hook_check edge cases ([ba50491](https://github.com/marklove5102/rtk/commit/ba50491cd615838c4f93455e94cdc32b7cb33d9b))
* align 7 TOML filter tests with on_empty behavior ([04ed6d8](https://github.com/marklove5102/rtk/commit/04ed6d8c314dcbf86b147903b5a7f1cd956dc980))
* align 7 TOML filter tests with on_empty behavior ([9a499b9](https://github.com/marklove5102/rtk/commit/9a499b9714e97a553d5603680ab1f843034acf28))
* apply clippy suggestions ([c6f35c9](https://github.com/marklove5102/rtk/commit/c6f35c9771e47e25f6284f292e9f9ddc27875de6))
* **automod:** add auto discovery for cmds ([234909d](https://github.com/marklove5102/rtk/commit/234909d2c754ade2fdc939b0a1435a8e34ffc305))
* **benchmark:** address PR review feedback ([87ee81f](https://github.com/marklove5102/rtk/commit/87ee81f08be5e7b1ca79513b1a91925d455f4f5c))
* **benchmark:** address review feedback from @FlorianBruniaux ([d13c185](https://github.com/marklove5102/rtk/commit/d13c185aac64d14288b574df44623723a69e7b95))
* bugs [#196](https://github.com/marklove5102/rtk/issues/196) [#344](https://github.com/marklove5102/rtk/issues/344) [#345](https://github.com/marklove5102/rtk/issues/345) [#346](https://github.com/marklove5102/rtk/issues/346) [#347](https://github.com/marklove5102/rtk/issues/347) — gh --json, hook check, RTK_DISABLED, 2&gt;&1, json TOML ([8953af0](https://github.com/marklove5102/rtk/commit/8953af0fc06759b37f16743ef383af0a52af2bed))
* **build:** increase Windows startup stack ([12276c1](https://github.com/marklove5102/rtk/commit/12276c174378d5fdbd7deb37f921bd8a46806cd4))
* **cargo:** preserve test compile diagnostics ([97b6878](https://github.com/marklove5102/rtk/commit/97b68783f50d209c2c599ae42cc638520749e668))
* **cargo:** show clippy error details in compact output ([def3424](https://github.com/marklove5102/rtk/commit/def3424eb470aeeac2570921b2d40a839690fe70))
* **ccusage:** add --yes flag and warn when falling back to npx ([f68fa00](https://github.com/marklove5102/rtk/commit/f68fa0087c03d6882993b7b3eaee98e1dbab41b4))
* **cicd-docs:** add agent reviewer + some contribute guidelines ([de710f4](https://github.com/marklove5102/rtk/commit/de710f4ea30c333130c46f8a2e2c5b6b9edd4889))
* **cicd-docs:** some logs to understand what is happening when check docs ([191ea9a](https://github.com/marklove5102/rtk/commit/191ea9af9f99ee78d74385fe1952ce83045e4afe))
* **cicd:** Clean cicd, rework depends and add pre-release ([d24a765](https://github.com/marklove5102/rtk/commit/d24a7650e26aca89224a3ec5d263f1ce7c7121d6))
* **cicd:** Clean cicd, rework depends and add pre-release ([6303e95](https://github.com/marklove5102/rtk/commit/6303e9530a379a8e3939e6c122ab4cf07cb16751))
* **cicd:** clippy - do not treat warn as error ([5da5db2](https://github.com/marklove5102/rtk/commit/5da5db222d9927394995ccaeb3afc103e80c22bd))
* **cicd:** dev- prefix for pre-release tags ([522bd64](https://github.com/marklove5102/rtk/commit/522bd648c8cae41f6cadedcd40a96d879c6ecf0a))
* **cicd:** explicit fetch tag ([3b94b60](https://github.com/marklove5102/rtk/commit/3b94b602ed24b9ecec597ce001e59f325caaadd4))
* **cicd:** gete release like tag for pre-release ([53bc81e](https://github.com/marklove5102/rtk/commit/53bc81e9e6d3d0876fb1a23dbf6f08bc074b68be))
* **cicd:** issue 668 - pre release tag ([200af43](https://github.com/marklove5102/rtk/commit/200af436d48dd2539cb00652b082f25c57873c9c))
* **cicd:** missing doc ([8657494](https://github.com/marklove5102/rtk/commit/865749438e67f6da7f719d054bf377d857925ad3))
* **cicd:** pre-release correct tag ([1536667](https://github.com/marklove5102/rtk/commit/15366678adeece701f38e91204128b070c0e3fc4))
* **cicd:** use dev- prefix for pre-release tags ([9c21275](https://github.com/marklove5102/rtk/commit/9c212752fc0401820f8665198f00882684496175))
* **cicd:** use dev- prefix for pre-release tags to avoid polluting release-please ([32c67e0](https://github.com/marklove5102/rtk/commit/32c67e01326374f0365602f61542a3639a8f121b))
* **ci:** fix validate-docs.sh broken module count check ([2b2163d](https://github.com/marklove5102/rtk/commit/2b2163d653de6d600318b40e2f8c8f72acd12b28))
* **ci:** fix validate-docs.sh broken module count check ([bbe3da6](https://github.com/marklove5102/rtk/commit/bbe3da642b5fc4b065b13a65647ea0ebf5264e65))
* **claude:** restore performance skill as directory ([b3cdde6](https://github.com/marklove5102/rtk/commit/b3cdde6a62c3cd2b2b8215e3e01099cc33589b95))
* **cleaning:** constant extract ([aabc016](https://github.com/marklove5102/rtk/commit/aabc0167bc013fd2d0c61a687580f6e69305500a))
* **clippy:** show full error blocks instead of truncated headline ([95d9d13](https://github.com/marklove5102/rtk/commit/95d9d134b0b76d83b6162614b0a79269b2135f40))
* **clippy:** show full error blocks instead of truncated headline ([f4074f8](https://github.com/marklove5102/rtk/commit/f4074f898a9b73b72bbcd8b18afab4831dcda406)), closes [#602](https://github.com/marklove5102/rtk/issues/602)
* **cloud:** reuse early exit for edge case ([23c0b7e](https://github.com/marklove5102/rtk/commit/23c0b7e433f3afad41eccf1d227c9f9bedf27325))
* **cmd:** read/cat multiple file and consistent behavior ([3f58018](https://github.com/marklove5102/rtk/commit/3f58018f4af1d7206457929cf80bb4534203c3ee))
* **cmds:** add run_filtered wrapper to remaining cmd ([078ad1d](https://github.com/marklove5102/rtk/commit/078ad1d5032ddb8acc89c8e6e9b967ccf252592d))
* **cmds:** exit code unified return code flow ([32ff466](https://github.com/marklove5102/rtk/commit/32ff4663cda97297bd6996fcab48c4e338bda66f))
* **cmds:** migrate remaining exit_code to exit_code_from_output ([ba9fa34](https://github.com/marklove5102/rtk/commit/ba9fa345f3d1d14bd0af236ec9aa8a9a0e5581d6))
* **cmds:** more covering for run_filtered ([e48485a](https://github.com/marklove5102/rtk/commit/e48485adc6a33d12b70664598020595cf7dfcd7e))
* **cmds:** shared cmd execution flow + clean & update docs ([77a0951](https://github.com/marklove5102/rtk/commit/77a09514337ca89afdc502c76d39e86e156d9fee))
* **core:** error handl, RAW_CAP, recursion guard, atomic writes ([0d07f04](https://github.com/marklove5102/rtk/commit/0d07f04d03dd5f09b10dd7aea5a5479f0612da71))
* **core:** review 956 various fix ([840571f](https://github.com/marklove5102/rtk/commit/840571fe90ed14fb7e96f9b9000a1bac6d196d23))
* curl JSON size guard ([#297](https://github.com/marklove5102/rtk/issues/297)) + exclude_commands config ([#243](https://github.com/marklove5102/rtk/issues/243)) ([#342](https://github.com/marklove5102/rtk/issues/342)) ([a8d6106](https://github.com/marklove5102/rtk/commit/a8d6106f736e049013ecb77f0f413167266dd40e))
* **curl:** skip JSON schema conversion for internal/localhost URLs ([577c311](https://github.com/marklove5102/rtk/commit/577c311ecaaa8ae94f22dbe252152424d4333d04))
* detect and warn RTK_DISABLED=1 overuse ([#508](https://github.com/marklove5102/rtk/issues/508)) ([ae96e74](https://github.com/marklove5102/rtk/commit/ae96e74580884137611b0ce155940484d27d07ad))
* **diff:** correct truncation overflow count in condense_unified_diff ([5399f83](https://github.com/marklove5102/rtk/commit/5399f836a5c642121f0f6e7812ff4131d84d0509))
* **diff:** never truncate diff content — show all changes in full ([80fc29a](https://github.com/marklove5102/rtk/commit/80fc29a839f51ef605474037e1a8fd86b4aac05a)), closes [#827](https://github.com/marklove5102/rtk/issues/827)
* disable help flag for psql command to allow -h host argument ([41e0897](https://github.com/marklove5102/rtk/commit/41e089759a13eae04535d1429ab7332d161a0e53))
* **discover:** exclude_commands bypass for env-prefix, sub cmd + regex ([ca4c59c](https://github.com/marklove5102/rtk/commit/ca4c59c230306d310069bed3c0ba930068dc4dc4))
* **discover:** exclude_commands bypass for env-prefix, sub cmd + regex ([42d3161](https://github.com/marklove5102/rtk/commit/42d3161872713bc0b20ef49b0714add40c40d5e3))
* **discover:** preserve golangci-lint flags in rewrite ([d85303e](https://github.com/marklove5102/rtk/commit/d85303ec4893deb904260f5dc11b7df906a50c07))
* **discover:** weighted savings rate per bucket, decimal already_rtk percent ([82c62eb](https://github.com/marklove5102/rtk/commit/82c62eb893966b8f170ea22ec72e79f14789e12e))
* **discover:** word boundary in exclude_commands ([0ea115b](https://github.com/marklove5102/rtk/commit/0ea115bca5fa66daa69fda2f0eeaaf103346b3a4))
* **docs:** add documentation ([2f7278a](https://github.com/marklove5102/rtk/commit/2f7278ac5992bf2e84b763fb05642d89900ba495))
* **docs:** add maintainers docs ([14265b4](https://github.com/marklove5102/rtk/commit/14265b48c3a15e459a31da11250a51ab5830a508))
* **docs:** add missing docs for exclude commands patterns ([2e401ac](https://github.com/marklove5102/rtk/commit/2e401ac38feec88de8d5e46f0301c8a532b95614))
* **docs:** clean some docs + disclaimer ([deda44f](https://github.com/marklove5102/rtk/commit/deda44f73607981f3d27ecc6341ce927aab34d37))
* **docs:** last review ([0925cf2](https://github.com/marklove5102/rtk/commit/0925cf21e0dd8cfac928ffb4220e8358b2474199))
* **docs:** update TELEMETRY.md to match code after review fixes ([be5c057](https://github.com/marklove5102/rtk/commit/be5c0576d95566f37f266fd9f92e2a1b263697bd))
* **docs:** use release please changelog no manual ([7591a14](https://github.com/marklove5102/rtk/commit/7591a14e4ceb732ab7ca160ac01a852926abe77a))
* **docs:** user facing docs ([c8d6878](https://github.com/marklove5102/rtk/commit/c8d68787fb8b31c52125e9fc7ea62e0aa590485f))
* **dotnet:** TRX injection for Microsoft.Testing.Platform projects ([8eefef1](https://github.com/marklove5102/rtk/commit/8eefef1b496035ce898effc5446e6851084d6fa4))
* **emots:** replace 📊 with "Summary:" ([495a152](https://github.com/marklove5102/rtk/commit/495a152059feabc7b516b96e804757608b87a10a))
* failing context for doc analyze -&gt; cat from files ([c6b7db2](https://github.com/marklove5102/rtk/commit/c6b7db2e5a6cd9a05262e934b4fc7a44c699c3b0))
* **find:** include hidden files when pattern targets dotfiles ([#1101](https://github.com/marklove5102/rtk/issues/1101)) ([dbeeaed](https://github.com/marklove5102/rtk/commit/dbeeaed16aee79674ec2fd3778b7b11b10b847c6))
* fix gh pr status invalid field and forward args correctly ([a5d6a72](https://github.com/marklove5102/rtk/commit/a5d6a72f48fb0468e83ccdb33a486a4cbc077243))
* fix ls -la output parsing ([e6b87d4](https://github.com/marklove5102/rtk/commit/e6b87d4eb28b9a6349ad7d805edbb5fd723cb89c))
* **formatter:** show full error message for test failures ([#690](https://github.com/marklove5102/rtk/issues/690)) ([dc6b026](https://github.com/marklove5102/rtk/commit/dc6b0260ab4c1bdbccb4b775d879eb473b212c21))
* **formatter:** show full error message for test failures ([#690](https://github.com/marklove5102/rtk/issues/690)) ([f7b09fc](https://github.com/marklove5102/rtk/commit/f7b09fc86a693acf2b52954215ff0c4e6c5d03f9))
* **gain:** convert history timestamps from UTC to local timezone ([140e1f5](https://github.com/marklove5102/rtk/commit/140e1f5958152ad170984bc4337a1206abeab15b))
* gh pr edit/comment pass correct subcommand to gh ([#332](https://github.com/marklove5102/rtk/issues/332)) ([799f085](https://github.com/marklove5102/rtk/commit/799f0856e4547318230fe150a43f50ab82e1cf03))
* gh run view --job flag loses its value ([#416](https://github.com/marklove5102/rtk/issues/416)) ([#477](https://github.com/marklove5102/rtk/issues/477)) ([3f37f5a](https://github.com/marklove5102/rtk/commit/3f37f5a78f7d4faa2900455a57fee645cf0d651f))
* **gh:** pass through gh pr merge instead of canned response ([#938](https://github.com/marklove5102/rtk/issues/938)) ([8465ca9](https://github.com/marklove5102/rtk/commit/8465ca953fa9d70dcc971a941c19465d456eb7d4))
* **gh:** pass through gh pr merge instead of canned response ([#938](https://github.com/marklove5102/rtk/issues/938)) ([e1f2845](https://github.com/marklove5102/rtk/commit/e1f2845df06a8d8b8325945dc4940ec5f530e4cc))
* **gh:** passthrough --comments flag in issue/pr view ([75cd223](https://github.com/marklove5102/rtk/commit/75cd2232e274f898d8a335ba866fc507ce64b949))
* **gh:** passthrough --comments flag in issue/pr view ([fdeb09f](https://github.com/marklove5102/rtk/commit/fdeb09fb93564e795711e9a531d2e2e20187c3a7)), closes [#720](https://github.com/marklove5102/rtk/issues/720)
* **gh:** show "No Pull Requests" / "No Issues" for empty lists ([ec4d243](https://github.com/marklove5102/rtk/commit/ec4d24380dae9b3e472e5abd0f435b0854c437de)), closes [#764](https://github.com/marklove5102/rtk/issues/764)
* **gh:** skip compact_diff for --name-only/--stat flags in pr diff ([2ef0690](https://github.com/marklove5102/rtk/commit/2ef0690767eb733c705e4de56d02c64696a4acc6)), closes [#730](https://github.com/marklove5102/rtk/issues/730)
* **gh:** skip compact_diff for --name-only/--stat in pr diff ([c576249](https://github.com/marklove5102/rtk/commit/c57624931a96181f869645817fdd96bc056da044))
* git log --oneline no longer silently truncated to 10 entries ([#461](https://github.com/marklove5102/rtk/issues/461)) ([#478](https://github.com/marklove5102/rtk/issues/478)) ([b2c2914](https://github.com/marklove5102/rtk/commit/b2c2914b90d87ffc05d0afe65fe3288ff5f05f4a))
* git log --oneline regression drops commits ([#619](https://github.com/marklove5102/rtk/issues/619)) ([8e85d67](https://github.com/marklove5102/rtk/commit/8e85d676d78b12d2c421bb892f93971fc222fb39))
* **git:** inherit stdin for commit and push to preserve SSH signing ([#733](https://github.com/marklove5102/rtk/issues/733)) ([eefeae4](https://github.com/marklove5102/rtk/commit/eefeae45656ff2607c3f519c8eae235e3f0fe411))
* **git:** inherit stdin for commit and push to preserve SSH signing ([#733](https://github.com/marklove5102/rtk/issues/733)) ([6cee6c6](https://github.com/marklove5102/rtk/commit/6cee6c60b80f914ed9505e3925d85cadec43ab97))
* **git:** preserve full diff hunk headers ([62f4452](https://github.com/marklove5102/rtk/commit/62f445227679f3df293fe35e9b18cc5ab39d7963))
* **git:** preserve full diff hunk headers ([09b3ff9](https://github.com/marklove5102/rtk/commit/09b3ff9424e055f5fe25e535e5b60e077f8344f9))
* **git:** re-insert -- separator when clap consumes it from git diff args ([#1215](https://github.com/marklove5102/rtk/issues/1215)) ([9979c69](https://github.com/marklove5102/rtk/commit/9979c699307a4adad2c2df0f2bc3b663df653311))
* **git:** remove -u short alias from --ultra-compact to fix git push -u ([6b76fdb](https://github.com/marklove5102/rtk/commit/6b76fdb87d7c54cfc2a1b0e6117dd78b8430910b))
* **git:** replace vague truncation markers with exact counts ([185fb97](https://github.com/marklove5102/rtk/commit/185fb97061517922ea5844d8c6008f2eb86fd55d))
* **go:** align go tool golangci-lint with Result&lt;i32&gt; ([48ec28d](https://github.com/marklove5102/rtk/commit/48ec28d53148a08ff9eba16c998e83991ebaf107))
* **go:** avoid false build errors from download logs ([9c1cf2f](https://github.com/marklove5102/rtk/commit/9c1cf2f403534fa7874638b1b983c2d7f918a185))
* **go:** avoid false build errors from download logs ([d44fd3e](https://github.com/marklove5102/rtk/commit/d44fd3e034208e3bcd59c2c46f7720eec4f10c98))
* **go:** cover more build failure shapes ([2425ad6](https://github.com/marklove5102/rtk/commit/2425ad68e5386d19e5ec9ff1ca151a6d2c9a56d3))
* **golangci-lint:** add v2 compatibility with runtime version detection ([95a4961](https://github.com/marklove5102/rtk/commit/95a4961e4aa3ba5307b3dfad246c6168c4caeab8))
* **golangci-lint:** add v2 compatibility with runtime version detection ([3480ce5](https://github.com/marklove5102/rtk/commit/3480ce5e4ee588033b295a8d136aee1bef153468))
* **golangci-lint:** restore run wrapper and align guidance ([4f4e4d2](https://github.com/marklove5102/rtk/commit/4f4e4d2b5a3529030fe4089f60d2f4b8740b5d53))
* **golangci-lint:** support inline global flags before run ([24f2ada](https://github.com/marklove5102/rtk/commit/24f2adaf8fb541c2564fa7dfb423947932e68fb4))
* **golangci:** use resolved_command for version detection, move test fixture to file ([6aa5e90](https://github.com/marklove5102/rtk/commit/6aa5e90dc466f87c88a2401b4eb2aa0f323379f4))
* **go:** preserve failing test location context ([1481bc5](https://github.com/marklove5102/rtk/commit/1481bc590924031456a6022510275c29c09e330e))
* **go:** preserve failing test location context ([374fe64](https://github.com/marklove5102/rtk/commit/374fe64cfbedcd676733973e81a63a6dfecbb1b7))
* **go:** prevent double-counted failures when test-level fail also triggers package-level fail ([#958](https://github.com/marklove5102/rtk/issues/958)) ([4fc15ef](https://github.com/marklove5102/rtk/commit/4fc15ef2c1c80336ffaafa4179db4cee6f39236a))
* **go:** prevent double-counting failures when package-level fail cascades from test failures ([#958](https://github.com/marklove5102/rtk/issues/958)) ([9722d5e](https://github.com/marklove5102/rtk/commit/9722d5ebd8916f9b398bdc01b1102d42ab2b8795))
* **go:** restore build error coverage ([1177c9c](https://github.com/marklove5102/rtk/commit/1177c9c873ac63b6c0bcc9e1b664a705baa0ad7a))
* **grep:** close subprocess stdin to prevent memory leak ([#897](https://github.com/marklove5102/rtk/issues/897)) ([7217562](https://github.com/marklove5102/rtk/commit/72175623551f40b581b4a7f6ed966c1e4a9c7358))
* **grep:** close subprocess stdin to prevent memory leak ([#897](https://github.com/marklove5102/rtk/issues/897)) ([09979cf](https://github.com/marklove5102/rtk/commit/09979cf29701a1b775bcac761d24ec0e055d1bec))
* handle -n N and --max-count=N forms in git log limit parsing ([e67f52c](https://github.com/marklove5102/rtk/commit/e67f52ce48be57ce38bbcfe0e232758fb201893a))
* handle tail rewrites with read tail-lines ([a314927](https://github.com/marklove5102/rtk/commit/a314927051e76b2334abbad0b834329faa2b45c5))
* handle tail rewrites with read tail-lines ([02502d1](https://github.com/marklove5102/rtk/commit/02502d1366b61438ffbdbe52b235cb81b25fe3f8))
* hook security + stderr redirects + version bump ([#807](https://github.com/marklove5102/rtk/issues/807)) ([0649e97](https://github.com/marklove5102/rtk/commit/0649e974fb8f27778ef0d22aa97905d9ebc8f03c))
* **hook_check:** detect missing integrations ([9cf9ccc](https://github.com/marklove5102/rtk/commit/9cf9ccc1ac39f8bba37e932c7d318a3aa7a34ae9))
* **hook:** reduce rewrite hook spawn overhead ([b3a7e75](https://github.com/marklove5102/rtk/commit/b3a7e753fe97f9265be94c8bfeffd62099abb83c)), closes [#968](https://github.com/marklove5102/rtk/issues/968)
* **hook:** respect Claude Code deny/ask permission rules on rewrite ([a051a6f](https://github.com/marklove5102/rtk/commit/a051a6f5e56c7ee59375a365580bced634e29c02))
* **hook:** respect Claude Code deny/ask permission rules on rewrite ([a9c610a](https://github.com/marklove5102/rtk/commit/a9c610a9afedd748c8184ecb18911598a943da0e)), closes [#260](https://github.com/marklove5102/rtk/issues/260)
* **hook:** rewrite wc commands to rtk wc ([099a8f3](https://github.com/marklove5102/rtk/commit/099a8f3e6da4a81f280d1aa0ebf15ce6153b5c9d))
* **hooks:** add regression test for windows native ([115e448](https://github.com/marklove5102/rtk/commit/115e44853b8cdd2d7af3af2b52c9c31e924a45d3))
* **hooks:** ensure default permission verdict prompts user for confirmation ([40462c0](https://github.com/marklove5102/rtk/commit/40462c05e66f116928de365a0d271bdfd61cec72))
* **hooks:** permission checks, audit log injection, stdin limits ([41ebf0b](https://github.com/marklove5102/rtk/commit/41ebf0babbf6aee21a267230e8c101cc67f6b6a2))
* **hooks:** reduce jq invocations in rtk-rewrite\n\nFixes [#968](https://github.com/marklove5102/rtk/issues/968) ([74a1fd2](https://github.com/marklove5102/rtk/commit/74a1fd2765b235267aacf9a55aa6024c0590f003))
* **hooks:** require all segments to match allow rules ([#1213](https://github.com/marklove5102/rtk/issues/1213)) ([40c9dbc](https://github.com/marklove5102/rtk/commit/40c9dbc7dbbf9332d6859060765c582a880f0fde))
* **hooks:** windows use 'rtk hook claude' no fallback ([da3c432](https://github.com/marklove5102/rtk/commit/da3c432201240f0da9627d8cc6bc70e5b7f8bdfe))
* **hooks:** windows use 'rtk hook claude' no fallback ([0e29650](https://github.com/marklove5102/rtk/commit/0e29650e11959730f4c4a2e6d6c0519e14dc8595))
* improve adoption metric by detecting hook-rewritten commands ([eb8a2c4](https://github.com/marklove5102/rtk/commit/eb8a2c4a71072870fca4b64e90189a4453acff84))
* include Finished line in cargo build success output ([72b1e59](https://github.com/marklove5102/rtk/commit/72b1e592d91355b061a6dc317f27f90b66a03f97))
* increase signal in git diff, git log, and json filters ([#621](https://github.com/marklove5102/rtk/issues/621)) ([#708](https://github.com/marklove5102/rtk/issues/708)) ([4edc3fc](https://github.com/marklove5102/rtk/commit/4edc3fc0838e25ee6d1754c7e987b5507742f600))
* **init:** honor CODEX_HOME for Codex global paths ([d442799](https://github.com/marklove5102/rtk/commit/d442799e34d522c87a6eb60c2ff373385d201315))
* **init:** install Codex global instructions in CODEX_HOME ([a257688](https://github.com/marklove5102/rtk/commit/a2576883a27c5f915ba0ae7883a51006411b3ae5))
* **init:** remove opt-out instruction from telemetry message ([7571c8e](https://github.com/marklove5102/rtk/commit/7571c8e101c41ee64c51e2bd64697f85f9142423))
* **init:** remove telemetry info lines from init output ([7dbef2c](https://github.com/marklove5102/rtk/commit/7dbef2ce00824d26f2057e4c3c76e429e2e23088))
* isolate cursor hook tests from local settings (determinist) ([d8ddefe](https://github.com/marklove5102/rtk/commit/d8ddefe78efe25c35bb2a2f9083f2eacb9dd7274))
* **json:** rename --schema to --keys-only for clearer opt-in semantics ([097456e](https://github.com/marklove5102/rtk/commit/097456e525bc8b635faca8fd505957e1df0ba8f0))
* **json:** rename --schema to --keys-only, closes [#621](https://github.com/marklove5102/rtk/issues/621) ([c16713a](https://github.com/marklove5102/rtk/commit/c16713a973b563a6cba283c830b67c8c470e419f))
* **lexer:** re-add strip_quotes ([54861ab](https://github.com/marklove5102/rtk/commit/54861ab5b1de2bc0dc047d7ab6ea066bd8afb0eb))
* **ls:** filter quality wrong truncation ([aa6317f](https://github.com/marklove5102/rtk/commit/aa6317fb83a5d9883623a4d3bee7a25bc99dcb4c))
* **ls:** suppress summary line when stdout is piped ([b79623c](https://github.com/marklove5102/rtk/commit/b79623c3a66d6ab606e400711ee6c0fd2f80527c))
* **ls:** suppress summary line when stdout is piped ([b79623c](https://github.com/marklove5102/rtk/commit/b79623c3a66d6ab606e400711ee6c0fd2f80527c))
* **ls:** suppress summary line when stdout is piped ([3e1f75a](https://github.com/marklove5102/rtk/commit/3e1f75a8d5e1d89610319d469d51e377c4cb3cbe)), closes [#482](https://github.com/marklove5102/rtk/issues/482)
* **main:** kill zombie processes + path for rtk md ([d16fc6d](https://github.com/marklove5102/rtk/commit/d16fc6dacbfec912c21522939b15b7bbd9719487))
* **main:** kill zombie processes + path for rtk md + missing intergrations ([a919335](https://github.com/marklove5102/rtk/commit/a919335519ed4a5259a212e56407cb312aa99bac))
* **merge:** changelog conflicts ([d92c5d2](https://github.com/marklove5102/rtk/commit/d92c5d264a49483c8d6079e04d946a79bc990a74))
* **merge:** resolve conflict with develop in diff_cmd.rs ([6a5ae14](https://github.com/marklove5102/rtk/commit/6a5ae1484b32c38bd99baca925175ae610e3d1e3))
* normalize binlogs CRLF ([5344af9](https://github.com/marklove5102/rtk/commit/5344af9a51f06b5dc42692e42c948ff11a3173c6))
* npm routing, discover cat redirect, proxy quoted args ([#480](https://github.com/marklove5102/rtk/issues/480)) ([a2e07a5](https://github.com/marklove5102/rtk/commit/a2e07a5c8bc6dddd3429b28ab885bd1a39b93d61))
* only rewrite docker compose ps/logs/build, skip unsupported subcommands ([#336](https://github.com/marklove5102/rtk/issues/336)) ([#363](https://github.com/marklove5102/rtk/issues/363)) ([dbc9503](https://github.com/marklove5102/rtk/commit/dbc950395e31b4b0bc48710dc52ad01d4d73f9ba))
* P0+P1 fixes from pre-merge review of hook engine ([df8e035](https://github.com/marklove5102/rtk/commit/df8e03558d4d6cc2f5cbac91c63ab1b3b51d3bcd))
* P0+P1 fixes from pre-merge review of hook engine ([d34389c](https://github.com/marklove5102/rtk/commit/d34389c3d0936c2b0790e14f450bb50a28a7edf7))
* pass through -R/--repo flag in gh view commands ([#328](https://github.com/marklove5102/rtk/issues/328)) ([0a1bcb0](https://github.com/marklove5102/rtk/commit/0a1bcb05e5737311211369dcb92b3f756a6230c6)), closes [#223](https://github.com/marklove5102/rtk/issues/223)
* **permissions:** check deny rules before rewrite + flush stdout ([e303fe1](https://github.com/marklove5102/rtk/commit/e303fe1b6372bf1896527eb55a12c327f5d3c11d))
* **permissions:** glob_matches middle-wildcard matches commands without trailing args ([#1105](https://github.com/marklove5102/rtk/issues/1105)) ([3db8070](https://github.com/marklove5102/rtk/commit/3db8070b51b9a312fcca20a8460d3d6259cc38b7))
* **permissions:** support *:* and leading/middle wildcards ([49fac62](https://github.com/marklove5102/rtk/commit/49fac625f4f147c4f9c713882dade1d304da2b0c))
* **playwright:** add tee_and_hint pass-through on failure ([#690](https://github.com/marklove5102/rtk/issues/690)) ([b4ccf04](https://github.com/marklove5102/rtk/commit/b4ccf046f59ce6ed1396e4d8c46f8a35152d6d09))
* **pnpm:** list command not working ([ba235d8](https://github.com/marklove5102/rtk/commit/ba235d85974c0a85b25e290a8bb83648800438a6))
* preserve -- separator for cargo commands and silence fallback ([#326](https://github.com/marklove5102/rtk/issues/326)) ([45f9344](https://github.com/marklove5102/rtk/commit/45f9344f033d27bc370ff54c4fc0c61e52446076)), closes [#286](https://github.com/marklove5102/rtk/issues/286) [#287](https://github.com/marklove5102/rtk/issues/287)
* preserve cargo test compile diagnostics ([15d5beb](https://github.com/marklove5102/rtk/commit/15d5beb9f70caf1f84e9b506faaf840c70c1cf4e))
* preserve commit body in git log output ([e189bbb](https://github.com/marklove5102/rtk/commit/e189bbbe749120eda4d98a2130937269d8c0e92a))
* preserve first line of commit body in git log output ([c3416eb](https://github.com/marklove5102/rtk/commit/c3416eb45f2f97297ec149d296a6a500697d302b))
* preserve trailing newline in tail_lines + add missing test ([1448914](https://github.com/marklove5102/rtk/commit/144891472a186df79585924ab599744cc3ad87f8))
* prettier false positive when not installed ([#221](https://github.com/marklove5102/rtk/issues/221)) ([#359](https://github.com/marklove5102/rtk/issues/359)) ([85b0b3e](https://github.com/marklove5102/rtk/commit/85b0b3eb0bad9cbacdc32d2e9ba525728acd7cbe))
* **proxy:** kill child process on SIGINT/SIGTERM to prevent orphans ([d813919](https://github.com/marklove5102/rtk/commit/d813919a24546e044e7844fc7ed05fef4ec24033))
* **proxy:** kill child process on SIGINT/SIGTERM to prevent orphans ([3318510](https://github.com/marklove5102/rtk/commit/33185101fc122d0c11a25a4e02ac9f3a7dc7e3bb))
* **pytest:** -q mode summary line not detected ([57502a5](https://github.com/marklove5102/rtk/commit/57502a5bef1fb56109a57cf2ea7377fd271253a7))
* **pytest:** -q mode summary line not detected, reports "No tests collected" ([ecc34d7](https://github.com/marklove5102/rtk/commit/ecc34d7c89fe818d7446592d6695edd48890150a)), closes [#565](https://github.com/marklove5102/rtk/issues/565)
* **read:** default to no filtering — show full file content ([5e0f3ba](https://github.com/marklove5102/rtk/commit/5e0f3ba774eab52f8ca2ac603e2ae4eae79b2edc)), closes [#822](https://github.com/marklove5102/rtk/issues/822)
* **read:** detect binary files and prevent empty output on filter failure ([8886c14](https://github.com/marklove5102/rtk/commit/8886c14c9cf97fb4413efec3be8e50fdb84824e9)), closes [#822](https://github.com/marklove5102/rtk/issues/822)
* reduce gh diff / git diff / gh api truncation ([#354](https://github.com/marklove5102/rtk/issues/354)) ([#370](https://github.com/marklove5102/rtk/issues/370)) ([e356c12](https://github.com/marklove5102/rtk/commit/e356c1280da9896195d0dff91e152c5f20347a65))
* **refacto-codebase:** technical docs & sub folders ([927daef](https://github.com/marklove5102/rtk/commit/927daef49b8f771d195201d196378e27e0ee8a2b))
* **refacto-p1:** unified cmds execution flow  (+ rm dead code) ([75bd607](https://github.com/marklove5102/rtk/commit/75bd607d55235f313855f5fe8c9eceafd73700a7))
* **refacto-p2:** more standardize ([47a76ea](https://github.com/marklove5102/rtk/commit/47a76ea35ed2fe02a3600792163f727fa3a94ff2))
* **refacto-p2:** more standardize ([92c671a](https://github.com/marklove5102/rtk/commit/92c671a175a5e2bf09720fd1a8591140bcb473a0))
* **refacto:** conflict w/ dev ([135fea6](https://github.com/marklove5102/rtk/commit/135fea693e9cd0949226178e3e5823e7a71ad82a))
* **refacto:** rm old tmp file ([91992fd](https://github.com/marklove5102/rtk/commit/91992fd8dc4c7c87f4fd744672f9bf0909c67ba9))
* **refacto:** wrappers for standardization, exit codes lexer tokenizer, constants, code clean ([bff0258](https://github.com/marklove5102/rtk/commit/bff02584243f1b73418418b0c05365acf56fbb36))
* **registry:** quoted env prefix + inline regex cleanup + routing docs ([f3217a4](https://github.com/marklove5102/rtk/commit/f3217a467b543a3181605b257162f2b3ab5d5df0))
* remove all decorative emojis from CLI output ([#687](https://github.com/marklove5102/rtk/issues/687)) ([4d799b0](https://github.com/marklove5102/rtk/commit/4d799b0e0af5aaf654a8b89edf26c25bcdeac6b3))
* remove all decorative emojis from CLI output ([#687](https://github.com/marklove5102/rtk/issues/687)) ([#686](https://github.com/marklove5102/rtk/issues/686)) ([4792008](https://github.com/marklove5102/rtk/commit/4792008fc15553cbb9aeaa602f773a5f8f7f7afe))
* remove dead code ([6878819](https://github.com/marklove5102/rtk/commit/6878819798b3cb4b8ff53ce501464525d1922347))
* remove pnpx -&gt; rtk pnpx rule as rtk pnpx command doesn't exist ([325a42e](https://github.com/marklove5102/rtk/commit/325a42e09fd8de6d0c26914ff29ab11d8680f354))
* remove version check from validate-docs CI ([#476](https://github.com/marklove5102/rtk/issues/476)) ([#543](https://github.com/marklove5102/rtk/issues/543)) ([6e61c24](https://github.com/marklove5102/rtk/commit/6e61c2447cc03af94220ce6ce83686f155e18086))
* rename ship.md to ship/SKILL.md to match develop ([5916ecd](https://github.com/marklove5102/rtk/commit/5916ecd86fb319c2519a0b4fb2891309833a3bb4))
* report package-level failures (timeouts, signals) in go test summary ([0b1c32b](https://github.com/marklove5102/rtk/commit/0b1c32b3cc9a3e73418d401d1d481c1611c7ec0b))
* report package-level failures (timeouts, signals) in go test summary ([c85a387](https://github.com/marklove5102/rtk/commit/c85a387363e2079234b6141aad26418172c0e61a)), closes [#958](https://github.com/marklove5102/rtk/issues/958)
* resolve Windows command wrapper execution ([#269](https://github.com/marklove5102/rtk/issues/269)) ([2e194ef](https://github.com/marklove5102/rtk/commit/2e194efb3ac5e4cba51e13ec64d3f09196f772cf))
* respect user-specified git log limits ([#461](https://github.com/marklove5102/rtk/issues/461)) ([e06d77e](https://github.com/marklove5102/rtk/commit/e06d77ec92eba19074ff7b3a512067924ca763f2))
* respect user-specified git log limits instead of silently truncating ([07901c8](https://github.com/marklove5102/rtk/commit/07901c8249be03145c3495c4cb9969be80f8aad5)), closes [#461](https://github.com/marklove5102/rtk/issues/461)
* restore lost telemetry install_method enrichment ([#469](https://github.com/marklove5102/rtk/issues/469)) ([0c5cde9](https://github.com/marklove5102/rtk/commit/0c5cde9ec234a2b7b0376adbcb78f2be48a98e86))
* review iteration 2 — double-warning, case-sensitive test, ssh truncate ([7921e96](https://github.com/marklove5102/rtk/commit/7921e96dae7147c18f8e25437d61111700bc0224))
* **review:** address ChildGuard disarm, stdin dedup, hook masking ([d85fe33](https://github.com/marklove5102/rtk/commit/d85fe3384b87c16fafd25ec7bcadbff6e69f3f1f))
* **review:** address PR [#910](https://github.com/marklove5102/rtk/issues/910) review feedback ([0a8b8fd](https://github.com/marklove5102/rtk/commit/0a8b8fd0693fa504f376146cbbcafe9ddf4632c8))
* **review:** PR [#934](https://github.com/marklove5102/rtk/issues/934) ([5bd35a3](https://github.com/marklove5102/rtk/commit/5bd35a33ad6abe5278749726bed19912664531c2))
* **review:** PR [#934](https://github.com/marklove5102/rtk/issues/934) ([bae7930](https://github.com/marklove5102/rtk/commit/bae79301194bbb48d1cbb39554096c3225f7cb73))
* rewrite swift test commands ([599ad25](https://github.com/marklove5102/rtk/commit/599ad25deb0f8dc9ecab37f4bbe26324dac07b2e))
* rewrite swift test commands ([941a057](https://github.com/marklove5102/rtk/commit/941a057016c1d9b1c6ca9b887cf8c93e9c6e5be1)), closes [#765](https://github.com/marklove5102/rtk/issues/765)
* **rewrite:** skip cat rewrite when incompatible flags are present ([2fce6bf](https://github.com/marklove5102/rtk/commit/2fce6bfee7cd31fcd78282e696f586a3eeb1f810))
* rtk read no longer corrupts JSON files with glob patterns ([#464](https://github.com/marklove5102/rtk/issues/464)) ([#479](https://github.com/marklove5102/rtk/issues/479)) ([18f4401](https://github.com/marklove5102/rtk/commit/18f4401a939e5d64e3a658c9f9ee27b25e2de45c))
* rtk rewrite accepts multiple args without quotes ([#504](https://github.com/marklove5102/rtk/issues/504)) ([cb79b4c](https://github.com/marklove5102/rtk/commit/cb79b4c701cd29a3b84e21827250c9220b726e88))
* RTK_DISABLED ignored, 2&gt;&1 broken, json TOML error ([#345](https://github.com/marklove5102/rtk/issues/345), [#346](https://github.com/marklove5102/rtk/issues/346), [#347](https://github.com/marklove5102/rtk/issues/347)) ([6c13d23](https://github.com/marklove5102/rtk/commit/6c13d234364d314f53b6698c282a621019635fd6))
* **ruby:** use rails test for positional file args in rtk rake ([ec92c43](https://github.com/marklove5102/rtk/commit/ec92c43f231eb2321a4b423b0eb8487f98161aac))
* **ruby:** use rails test for positional file args in rtk rake ([138e914](https://github.com/marklove5102/rtk/commit/138e91411b4802e445a97429056cca73282d09e1))
* **rules:** add wc RtkRule with pattern field for develop compat ([d75e864](https://github.com/marklove5102/rtk/commit/d75e864f20451a5e17918c75f2ea32672f65e1f4))
* **runner:** preserve fd separation on command failure ([e92d099](https://github.com/marklove5102/rtk/commit/e92d0993c93f0b732316dfa932d265aeca7488d6))
* **scripts:** remove broken module count check from validate-docs.sh ([61e1d7b](https://github.com/marklove5102/rtk/commit/61e1d7b03a6446a7c178bb47ce0171295f4b1153))
* **security:** correct email domain from .dev to .app ([47383e8](https://github.com/marklove5102/rtk/commit/47383e80197fc56e38f880f33a6b54261b82523c))
* **security:** default to ask when no permission rule matches ([#886](https://github.com/marklove5102/rtk/issues/886)) ([158c745](https://github.com/marklove5102/rtk/commit/158c74527f6591d372e40a78cd604d73a20649a9))
* **security:** default to ask when no permission rule matches ([#886](https://github.com/marklove5102/rtk/issues/886)) ([41a6c6b](https://github.com/marklove5102/rtk/commit/41a6c6bf6da78a4754794fdc6a1469df2e327920))
* **security:** missing toml pkg ([51f9c88](https://github.com/marklove5102/rtk/commit/51f9c888b81169309df92f7fa3a6f705d44adcab))
* **security:** missing toml pkg ([eae2fee](https://github.com/marklove5102/rtk/commit/eae2fee0c251aab25315a9db8464f8ae1035c356))
* **security:** salt device hash for telemetry ([32fdbbb](https://github.com/marklove5102/rtk/commit/32fdbbbb6923c70d343fab14b4b0ce70424e610f))
* **security:** salt device hash for telemetry ([2d2f199](https://github.com/marklove5102/rtk/commit/2d2f1999830ab0925931de6b486bbf48da37d14e))
* **security:** salt device hash for telemetry ([60cba0f](https://github.com/marklove5102/rtk/commit/60cba0f5d840010d44cc899f443b65bb1ff608be))
* **security:** set 0600 permissions on salt file ([5eae11d](https://github.com/marklove5102/rtk/commit/5eae11d16410dc4ff26e97672e5367b14efaab76))
* **security:** set 0600 permissions on salt file ([8e42120](https://github.com/marklove5102/rtk/commit/8e42120ea397213682e031584fa352c713a713d5))
* **skill/rtk-triage:** increase PR/issue limit to 200 with pagination hint ([#717](https://github.com/marklove5102/rtk/issues/717)) ([5e1fc20](https://github.com/marklove5102/rtk/commit/5e1fc20cb0da68b73bf87c92ac74248a0df0ce30))
* skip rewrite for gh --json/--jq/--template ([#196](https://github.com/marklove5102/rtk/issues/196)) ([079ee9a](https://github.com/marklove5102/rtk/commit/079ee9a4ea868ecf4e7beffcbc681ca1ba8b165c))
* split chained commands in adoption metric ([127f85c](https://github.com/marklove5102/rtk/commit/127f85c02efd52a64e461005fa142d05f81615f8))
* **standardize:** git+kube sub wrappers run_filtered ([7fd221f](https://github.com/marklove5102/rtk/commit/7fd221f44660bcf411aa333d2c35a49ff89e7961))
* **standardize:** merge pattern into rues ([08aabb9](https://github.com/marklove5102/rtk/commit/08aabb95c3ae6e0b734f696264e1e1a8c0f0b22e))
* start folder & docs refacto ([f1ac236](https://github.com/marklove5102/rtk/commit/f1ac236e46204140845e5882ee58e907bcfad0f4))
* **stream:** missing stderr fields ([a1d46f3](https://github.com/marklove5102/rtk/commit/a1d46f39c291e3356b9c26a062bde05ba1de591a))
* **stream:** P0 fixes from PR [#956](https://github.com/marklove5102/rtk/issues/956) review ([2bb5265](https://github.com/marklove5102/rtk/commit/2bb5265595c4a80fe1ad7e9ab3ffc8dd013b019c))
* **stream:** skip printf-based tests on Win ([63313a2](https://github.com/marklove5102/rtk/commit/63313a25b6e15749fe047376414a9bd6bdf811a7))
* **stream:** stream engine & template + BlockHandler, RegexBlockFilter, signal guard, pipe rewrite ([b3936b8](https://github.com/marklove5102/rtk/commit/b3936b8e5d5fc2b5036b90aada61917fa3f3f7de))
* **stream:** wire run_streaming as standard exec for filter commands ([02e3a6f](https://github.com/marklove5102/rtk/commit/02e3a6f8f4639c86a585701cf5ed03c0f853e752))
* strip npx/bunx/pnpm prefixes in lint linter detection ([#186](https://github.com/marklove5102/rtk/issues/186)) ([#366](https://github.com/marklove5102/rtk/issues/366)) ([27b35d8](https://github.com/marklove5102/rtk/commit/27b35d84a341622aa4bf686c2ce8867f8feeb742))
* strip trailing stderr redirects before rewrite matching ([#530](https://github.com/marklove5102/rtk/issues/530)) ([edd9c02](https://github.com/marklove5102/rtk/commit/edd9c02e892b297a7e349031b61ef971c982b53d))
* strip trailing stderr redirects before rewrite matching ([#530](https://github.com/marklove5102/rtk/issues/530)) ([36a6f48](https://github.com/marklove5102/rtk/commit/36a6f482296d6fc85f8116040a16de2e128733f8))
* support git -C &lt;path&gt; in rewrite registry ([c916bab](https://github.com/marklove5102/rtk/commit/c916bab33ae9760b234fd720c944a849141f0d2e)), closes [#555](https://github.com/marklove5102/rtk/issues/555)
* support git commit -am, --amend and other flags ([#327](https://github.com/marklove5102/rtk/issues/327)) ([#360](https://github.com/marklove5102/rtk/issues/360)) ([409aed6](https://github.com/marklove5102/rtk/commit/409aed6dbcdd7cac2a48ec5655e6f1fd8d5248e3))
* **tee:** prevent panic on UTF-8 multi-byte truncation boundary ([da486bf](https://github.com/marklove5102/rtk/commit/da486bf394330c804cd1cd12e4b6835f18de5205))
* **telemetry:** 7 bugs in enrichment — privacy leak, broken meta_usage, pricing ([15f666d](https://github.com/marklove5102/rtk/commit/15f666dd8dbd18648cb7bd14a6f9f3cac2f7d10b))
* **telemetry:** cache salt in-process ([22dc059](https://github.com/marklove5102/rtk/commit/22dc059310b0408adedc2d1228de339e16ea6c0a))
* **telemetry:** cache salt in-process ([699f682](https://github.com/marklove5102/rtk/commit/699f68236ba3c13f8effdea39022dae1497ed9df))
* **telemetry:** clean code ([8156081](https://github.com/marklove5102/rtk/commit/81560812610686fa5ca3633c2bf0b79c05eaa7d9))
* **telemetry:** consent, erasure, auth, docs ([2e4cc4b](https://github.com/marklove5102/rtk/commit/2e4cc4bb5226444c8c0bfc827baf0c101c3759e8))
* **telemetry:** docs + real info from "rtk init -g" ([33195cc](https://github.com/marklove5102/rtk/commit/33195cc686318ddcca54edfdd1215bd9fd28f891))
* **telemetry:** docs + real info from "rtk init -g" ([f7ec883](https://github.com/marklove5102/rtk/commit/f7ec883a7816d645f6bfebb795c25638bc91586c))
* **telemetry:** hash + salt ([92996b1](https://github.com/marklove5102/rtk/commit/92996b127257eae16d3e17179592b2899f19254f))
* **telemetry:** non-terminal consent, single config load ([7821e98](https://github.com/marklove5102/rtk/commit/7821e9872fd1f1ae9b40eb8a4458049869acc36b))
* **telemetry:** RGPD-compliant, consent gate, erasure, privacy controls ([6a5bc84](https://github.com/marklove5102/rtk/commit/6a5bc847e06cf6066e6f4aeed5a3ad0803a3649b))
* test-all.sh aborts when gt not installed ([#500](https://github.com/marklove5102/rtk/issues/500)) ([#544](https://github.com/marklove5102/rtk/issues/544)) ([26f5473](https://github.com/marklove5102/rtk/commit/26f547371798ad32aed3569965303bc4857789ed))
* **tests:** windows regression test fix path ([13a73dd](https://github.com/marklove5102/rtk/commit/13a73ddfd78460560a1f5fde94b54b1f848b41b5))
* **tracking:** use std::env::temp_dir() for compatibility (instead of unix tmp) ([e918661](https://github.com/marklove5102/rtk/commit/e918661440d7b50321f0535032f52c5e87aaf3cb))
* truncation accuracy + Copilot init + binary file detection ([966bcbe](https://github.com/marklove5102/rtk/commit/966bcbe638be18bbaba4298df985804643f82c85))
* **truncation:** accurate overflow counts and omission indicators ([58a9633](https://github.com/marklove5102/rtk/commit/58a963347467613d48db05ad56bc8f1f3a06b65d))
* trust boundary followup — TOML key typo + missing meta commands ([#625](https://github.com/marklove5102/rtk/issues/625)) ([8d8e188](https://github.com/marklove5102/rtk/commit/8d8e188705e5784829693a83b2076d6118154764))
* update Discord invite link ([#711](https://github.com/marklove5102/rtk/issues/711)) ([#786](https://github.com/marklove5102/rtk/issues/786)) ([af56573](https://github.com/marklove5102/rtk/commit/af56573ae2b234123e4685fd945980e644f40fa3))
* use /usr/bin/env shebangs for portability across systems ([bec18c4](https://github.com/marklove5102/rtk/commit/bec18c40a2b6a730d380b5919590eacb7c734750))
* use rtk &lt;cmd&gt; instead of rtk proxy for TOML-filtered commands ([#507](https://github.com/marklove5102/rtk/issues/507)) ([e9eb152](https://github.com/marklove5102/rtk/commit/e9eb152c21e25762cecfbda6be2317d3e3e1def8))
* **vitest:** rework command to handle differences between vitest and jest ([70610da](https://github.com/marklove5102/rtk/commit/70610da4bbf0fd8f4226fc61895af61377eafcc8))
* warn when no hook installed + rtk gain hook status + PR [#499](https://github.com/marklove5102/rtk/issues/499) fixes ([22deca1](https://github.com/marklove5102/rtk/commit/22deca14ad393acbe6a0ec45f47d853c1339b87e))
* windows path fix for git tests ([0a904e2](https://github.com/marklove5102/rtk/commit/0a904e264d58f8f4b5f10e37ec3b11f717458fe0))
